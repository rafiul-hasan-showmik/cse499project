...
class _PayBillState extends State<PayBill> {
  ...
  TextEditingController _customerIDCollect = TextEditingController();
  TextEditingController _phoneNoCollect = TextEditingController();
...
// create order
  void createOrder() async {
    ...
    if (_check == true) {
      Navigator.of(context).pushNamed(SuccessfullPayment.routeName, arguments: {
        'customerID': _cid,
        'amount': _rAmount,
        'phone': _phoneNo,
        'month': dropdownvalue,
                ...
                DecoratedBox(
                  ...
                  child: Padding(
                    ...
                    child: DropdownButton(
                      dropdownColor: Color.fromARGB(255, 208, 234, 246),
                      value: dropdownvalue,
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  _cid = _customerIDCollect.text.toString();
                  _phoneNo = _phoneNoCollect.text.toString();
                  createOrder();
                },
